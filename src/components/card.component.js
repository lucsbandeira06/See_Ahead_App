...
export default function Card({data}) {
    ...
    return(
        ...
        Object.values(hotels).map((hotels,position) => (
            ...
            <div className="Card-container z-0 inline-flex items-stretch w-full h-72 space-x-1 content-between m-2 mb-4 bg-white rounded-md drop-shadow-lg border-2 p-3" key={position}>

                <div className="h-auto w-2/5 border-2 bg-slate-200 shadow-lg  justify-items-start">
                <img alt="main-pic" src={`${hotels.main_photo_url}`}/>    
                </div>
